...
const SuppliersPage: React.FC = () => {
  const [suppliers] = useState<Supplier[]>([
    {
      id: 1,
      company_name: 'イースト電子部品株式会社',
      contact_person: '田中美香',
      email: 'tanaka@east-electronics.co.jp',
      phone: '03-8888-9999',
    ...
    {
      id: 2,
      company_name: 'セントラル製鋼所',
      contact_person: '中村健司',
      email: 'nakamura@central-steel.co.jp',
      phone: '052-1111-2222',
    ...
    {
      id: 3,
      company_name: 'オーシャン樹脂工業',
      contact_person: '田村さくら',
      email: 'tamura@ocean-plastic.com',
      phone: '045-3333-4444',
    ...
    {
      id: 4,
      company_name: 'ウエスト化学工業',
      contact_person: '大阪太郎',
      email: 'osaka@west-chemical.co.jp',
      phone: '06-5555-6666',
    ...
    {
      id: 5,
      company_name: 'ワールド・サプライズ',
      contact_person: 'Smith John',
      email: 'john.smith@world-supplies.com',
      phone: '03-7777-8888',
